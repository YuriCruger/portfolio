...
export const useProjects = () => {
  ...
  return [
    ...
    },
    {
      id: "7",
      slug: "market-space",
      title: t_market_space("title"),
      description: t_market_space("description"),
      image: "/market_space/banner.png",
      repository: "https://github.com/YuriCruger/market-space-rn",
      web: "",
      cards: [
        {
          id: "1",
          title: t_market_space("cards.first.title"),
          description: t_market_space("cards.first.description"),
          image: "/market_space/login_page.png",
          className: "lg:row-span-6",
        },
        {
          id: "2",
          title: t_market_space("cards.second.title"),
          description: t_market_space("cards.second.description"),
          image: "/market_space/home_page.png",
          className: "lg:row-span-3",
        },
        {
          id: "3",
          title: t_market_space("cards.third.title"),
          description: t_market_space("cards.third.description"),
          image: "/market_space/ad_page.png",
          className: "lg:row-span-6",
        },
        {
          id: "4",
          title: t_market_space("cards.fourth.title"),
          description: t_market_space("cards.fourth.description"),
          image: "/market_space/ad_preview_page.png",
          className: "lg:row-span-3",
        },
      ],
      technologies: [
