...
export function Header() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`z-20 flex flex-col gap-4 rounded-md bg-zinc-300 p-3 opacity-0 duration-300 dark:bg-zinc-800 max-md:pointer-events-none max-md:absolute md:flex-row md:items-center md:gap-0 md:rounded-none md:bg-transparent md:p-0 md:opacity-100 dark:md:bg-transparent ${isMenuOpen && "pointer-events-auto opacity-100"}`}
      >
